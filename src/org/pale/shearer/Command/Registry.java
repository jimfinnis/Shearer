...
import org.pale.shearer.Command.CallInfo;
import org.pale.shearer.Command.Cmd;
        ...
        public void invoke(CallInfo c){
            try {
                ...
                if(c.getCitizen()==null && cmd.cz()){
                    c.msg("That command requires a selected Shearer");
                    return;
                }
    ...
    public void handleCommand(CommandSender sender,String[] args){
        if(args.length == 0){
            ...
            if(!registry.containsKey(cmdName)){
                Plugin.sendCmdMessage(sender,"unknown shearer command: "+cmdName);
            } else {
